...
function createComponent (
  ...
  console.log('propsData',data,Ctor,tag,JSON.parse(JSON.stringify(propsData)))
...
console.log('platformModules',platformModules,baseModules)
