...
function flushSchedulerQueue () {
  ...
  console.log('flushSchedulerQueue',currentFlushTimestamp)
  flushing = true;
  let watcher, id;
...
function queueWatcher (watcher) {
  ...
  if (has[id] == null) {
    ...
    console.log('queueWatcher',id,flushing,waiting,queue.length)
    // queue the flush
    if (!waiting) {
      waiting = true;
...
class Watcher {
  ...
  constructor (
    ...
    this.value = this.lazy
      ? undefined
      : this.get();
    console.log("Watcher1", this.user)
    console.log('Watcher',expOrFn,this.getter,this.id,this.deps)
  }
